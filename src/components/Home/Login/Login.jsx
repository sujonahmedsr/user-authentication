...
const Login = () => {
    ...
    return (
        <div className="py-20">
            <div className="container mx-auto max-w-md p-8 space-y-3 rounded-xl bg-gray-900   text-gray-100">
                ...
                <p className="text-xs text-center sm:px-6 text-gray-400 ">Dont have an account?
                    <Link to={'/registration'} className="underline text-gray-100 ">Sign up</Link>
                </p>
            </div>
